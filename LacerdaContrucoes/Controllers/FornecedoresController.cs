...
namespace LacerdaContrucoes.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,FornecedorNome,FornecedorCNPJ")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FornecedorId,FornecedorNome,FornecedorCNPJ")] Fornecedor fornecedor)
        {
